...
export class DatabaseService {
     ...
     */
    public static async getStreamersbyServer(guildId: number|string): Promise<Array<StreamerData>>
    {
     ...
     */
    public static async addStreamer(streamerName: string, guildId: string, channelId: string): Promise<boolean> {
     ...
     * @returns Promise<boolean>
     */
    public static async removeStreamer(streamerName: string, guildId: string): Promise<boolean> {
        ...
        return db.set(`${guildId}_streamers`, streamers.filter(obj => obj !== streamerFound));
    }
     ...
     * @returns Promise<boolean>
     */
    public static async updateList(streamers: Array<StreamerData>, guildId: string): Promise<boolean> {
